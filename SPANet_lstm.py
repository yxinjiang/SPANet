...
class Renet(nn.Module):
    def __init__(self, in_channels, out_channels=1,hidden_size=256):
        ...
        self.conv_down = nn.Conv2d(256, out_channels, 1)
        self.conv_up = nn.Conv2d(256, out_channels, 1)
        self.conv_right = nn.Conv2d(256, out_channels, 1)
        self.conv_left = nn.Conv2d(256, out_channels, 1)

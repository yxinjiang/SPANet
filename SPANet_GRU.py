...
class Renet(nn.Module):
    def __init__(self, in_channels):
        ...
        self.vertical = nn.GRU(input_size=in_channels, hidden_size=in_channels, batch_first=True,
                                bidirectional=True)  # each row
        self.horizontal = nn.GRU(input_size=in_channels, hidden_size=in_channels, batch_first=True,
